...
namespace P2Project.Accounts.Infrastructure.Migrations
{
    ...
    [Migration("20250127115055_Accounts_InitialAccountsWithAdmin")]
    partial class Accounts_InitialAccountsWithAdmin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P2Project.Accounts.Domain.Accounts.AdminAccount", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "P2Project.Accounts.Domain.Accounts.AdminAccount.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
